...
public class PazienteDentista extends JFrame {
    ...
    private void deleteSelectedRows(ActionEvent e) {
        ...
        if (selectedRow != -1) {
            ...
            try {
            	controller.deletePaziente(codiceFiscale);
    ...
    public void saveLastRow(ActionEvent e) {
        ...
        if (lastRowIndex >= 0) {
            ...
            if (validateRow(cognome, nome, dataDiNascita, codiceFiscale, nomeDottore)) {
                ...
                try {
                	controller.addPaziente(paziente);
    ...
    private void loadDataFromDatabase() {
        try {
            List<Paziente> pazienti = controller.getAllPazienti();
