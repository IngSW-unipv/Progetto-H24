...
public class Orario_Dottore_Dentista extends JFrame {
    ...
    private void saveLastRowToDatabase() {
        ...
        if (lastRowIndex >= 0) {
            ...
            try {
            	controller.addOrarioDottore(cognome, nome, email, numeroDiTelefono, orario);
    ...
    private void loadDataFromDatabase() {
        try {
            List<String[]> orari = controller.getAllOrariDottore();
    ...
    private void deleteSelectedRows() {
        ...
        for (int i = selectedRows.length - 1; i >= 0; i--) {
            ...
            try {
            	controller.deleteOrarioDottore(email);
