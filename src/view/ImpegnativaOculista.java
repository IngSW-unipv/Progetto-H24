...
public class ImpegnativaOculista extends JFrame {
    ...
    private void saveAllRowsToDatabase() {
        for (int i = 0; i < tableModel.getRowCount(); i++) {
            ...
            if (validateFields(prezzo, descrizione, trattamento, codiceFiscale)) {
				...
				Impegnativa servizi = new Impegnativa(prezzo, descrizione, trattamento, codiceFiscale,"Oculista");
                try {
    ...
    public static void main(String[] args) {
        ...
        frame.add(new ImpegnativaOculista()); 
