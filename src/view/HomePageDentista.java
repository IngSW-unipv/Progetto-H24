...
public class HomePageDentista extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
      if (e.getSource() == num1) {
	    ...
	    RicevimentiDentista ricivimenti = new RicevimentiDentista(tipoUtente);
            panel3.removeAll();
            panel3.revalidate();
            panel3.repaint();
            ...
            ImpegnativaDentista impegnativaDentista = new ImpegnativaDentista();
            panel3.removeAll();
            panel3.revalidate();
            panel3.repaint();
            panel3.add(impegnativaDentista.getPanelA(), BorderLayout.CENTER);
