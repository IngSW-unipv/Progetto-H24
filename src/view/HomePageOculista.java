...
public class HomePageOculista extends JFrame implements ActionListener {
   ...
   JTextField label1 =new JTextField(); 
    ...
    JButton num3 = new JButton("IMPEGNATIVA");			
    ...
    public void actionPerformed(ActionEvent e) {
      if (e.getSource() == num1) {
          String tipoUtente="Oculista";
            RicevimentiOculista ricivimenti = new RicevimentiOculista(tipoUtente);
            panel3.removeAll();
            panel3.revalidate();
            panel3.repaint();
            ...
            ImpegnativaOculista impegnativaOculista = new ImpegnativaOculista();
            panel3.removeAll();
            panel3.revalidate();
            panel3.repaint();
            panel3.add(impegnativaOculista.getPanelA(), BorderLayout.CENTER);
